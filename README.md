# booky
booky is a minimalistic TUI tool for managing your growing book collection. It is writtin in Rust and uses [Diesel](https://diesel.rs/) as it's ORM together with Sqlite. The Tui is created using the awesome Rust crate called [ratatui](https://crates.io/crates/ratatui)
